...
gdp_agg_1980 = sector_by_year_to_gdp['Agriculture, forestry, fishing'][1980] * 10 ** 6
print 'my_result: ${:,}'.format(int(gdp_agg_1980))
...
country_to_percent_gdp_agg_1980 = {
  'China': 29.9,
  'Korea': 15.9,
  'New Zealand': 11.1,
  'Finland': 9.6,
...
country_to_agg_gdp_1980_usd = {
  country: country_to_percent_gdp_agg_1980[country] / 100 * country_to_gdp_1980_usd[country]
