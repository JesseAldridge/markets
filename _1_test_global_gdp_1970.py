...
country_by_year_to_gdp = _0_parse_oecd.GDPTotalInfo().country_by_year_to_gdp_total
countries = country_by_year_to_gdp.keys()
gdps_1970_USD1970 = [country_by_year_to_gdp[country][1970] * 10**6 for country in countries]
